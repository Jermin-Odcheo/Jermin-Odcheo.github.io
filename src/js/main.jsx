...
// Import resume PDF so Vite handles it in production builds
...
function Navigation() {
    ...
    return (
        <nav className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 px-4 ${
            ...
            <div
                className="bg-[#111827]/90 backdrop-blur-md rounded-full px-3 sm:px-6 py-2 sm:py-3 border border-[#374151] shadow-2xl">
                {/* Desktop Navigation */}
            ...
            {isMobileMenuOpen && (
                <div
                    className="sm:hidden absolute top-full left-0 right-0 mt-2 bg-[#111827]/95 backdrop-blur-md rounded-xl border border-[#374151] shadow-2xl overflow-hidden">
                    {['experience', 'projects', 'certifications', 'contact'].map((section) => (
                        <button
                            key={section}
                            onClick={(e) => scrollToSection(section, e)}
        ...
        <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden py-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
                    ...
                    <AnimatedSection animation="fadeInLeft" className="text-center lg:text-left space-y-8">
                        ...
                        <AnimatedSection delay={200} className="flex justify-center lg:justify-start">
                            <div
                                className="bg-green-500/20 border border-green-500/50 rounded-full px-6 py-2 flex items-center space-x-2">
                        ...
                        <AnimatedSection animation="scaleIn" delay={400}
                            ...
                            <div
                                className="w-32 h-32 rounded-full bg-gradient-to-br from-[#374151] to-[#6b7280] p-1 hover:scale-110 transition-transform duration-300">
                                <div
                                    className="w-full h-full rounded-full bg-[#f9fafb] flex items-center justify-center">
                        ...
                        <AnimatedSection delay={600}>
                            ...
                            <div
                                className="flex items-center justify-center lg:justify-start space-x-4 text-[#6b7280] mb-6">
                        ...
                        <AnimatedSection delay={800}
                                         className="bg-[#374151]/20 backdrop-blur-sm rounded-xl p-6 border border-[#6b7280]/30">
                            <h3 className="text-[#f9fafb] font-semibold mb-3 flex items-center">
                                <i className="fas fa-user mr-2"></i>
                                Professional Summary
                            </h3>
                            <p className="text-[#9ca3af] leading-relaxed">
                                I'm a full-stack developer skilled in modern web technologies and AI integration. I'm
                                eager to build scalable web applications and contribute to innovative projects with a
                                dynamic team.
                            </p>
                        </AnimatedSection>
                        ...
                        <AnimatedSection delay={300}
                            ...
                            <StaggeredContainer className="grid grid-cols-2 gap-3">
                                {skills.map((skill, index) => (
                                    ...
                                    >
                                        <div
                                            className={`w-6 h-6 rounded bg-gradient-to-r ${skill.color} flex items-center justify-center flex-shrink-0`}>
                        ...
                        <AnimatedSection delay={500}
                            ...
                            <div className="space-y-4">
                                <div className="border-l-2 border-[#9ca3af]/30 pl-4">
                                    <h4 className="text-[#f9fafb] font-medium">Bachelor of Science in Information
                                        Technology</h4>
            ...
            {showResume && (
                <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4">
                    <div
                        className="bg-[#374151] rounded-xl max-w-6xl w-full max-h-[95vh] overflow-hidden border border-[#6b7280] shadow-2xl">
                        <div
                            className="p-4 sm:p-6 border-b border-[#6b7280] flex justify-between items-center bg-[#374151] z-10">
                            <div>
...
function Experience() {
            ...
            >
                ...
                >
                    <div className="flex flex-col sm:flex-row sm:justify-between items-start gap-2 mb-4">
                        ...
                        <span
                            className="text-xs sm:text-sm px-2 py-0.5 sm:px-3 sm:py-1 text-[#9ca3af] bg-[#111827]/50 rounded-full whitespace-nowrap">
    {exp.period}
</span>
    ...
    return (
        ...
        >
            <div
                className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#6b7280] to-transparent"></div>
        ...
        >
            ...
            <div className="container mx-auto px-6 max-w-6xl">
                ...
                >
                    {projects.map((project, index) => (
                        ...
                        >
                            <div
                                className="bg-[#374151]/20 backdrop-blur-sm rounded-xl overflow-hidden hover:bg-[#374151]/30 transition-all duration-300 border border-[#6b7280]/30 hover:shadow-2xl hover:scale-105 h-full flex flex-col">
                                <div className="relative h-48 overflow-hidden flex-shrink-0">
                                    {project.image ? (
                                        ...
                                        <div
                                            className="w-full h-full bg-gradient-to-br from-[#374151] to-[#6b7280] flex flex-col items-center justify-center text-center p-6 group-hover:from-[#6b7280] group-hover:to-[#9ca3af] transition-all duration-300">
                                            <div
                                                className="bg-[#111827]/30 rounded-full p-4 mb-3 group-hover:bg-[#111827]/50 transition-all duration-300">
            ...
            {showModal && selectedProject && (
                <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-2 sm:p-4">
                    <div
                        className="bg-[#374151] rounded-xl max-w-6xl w-full max-h-[95vh] sm:max-h-[90vh] overflow-auto border border-[#6b7280] shadow-2xl">
                        <div
                            className="p-4 sm:p-6 border-b border-[#6b7280] flex justify-between items-center sticky top-0 bg-[#374151] z-10">
                            <div>
                        ...
                        <div className="p-4 sm:p-6">
                            ...
                            <div className="space-y-4 sm:space-y-6">
                                {selectedProject.screenshots && selectedProject.screenshots.map((screenshot, index) => (
                                    <div key={index}
                                         className="bg-[#111827]/50 rounded-lg p-3 sm:p-4 border border-[#6b7280]/30 hover:border-[#9ca3af]/50 transition-all duration-300">
                                        ...
                                        <div className="flex justify-center group cursor-pointer"
                                             onClick={() => zoomImage(screenshot.src)}>
                                            <div className="relative">
                                                <img
                                                    src={screenshot.src}
                                                ...
                                                />
                                                <div
                                                    className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity duration-300 rounded-lg">
                            ...
                            <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-[#6b7280]/30">
                                <h4 className="text-[#f9fafb] font-medium mb-2 sm:mb-3 text-sm sm:text-base">Technologies
                                    Used:</h4>
                                <div className="flex flex-wrap gap-2">
            ...
            {zoomedImage && (
                <div className="fixed inset-0 bg-black/95 flex items-center justify-center z-60 p-4 overflow-auto"
        ...
        >
                ...
                >
                    {certificates.map((cert, index) => (
                        <motion.div key={cert.id} className="group h-full" variants={fadeInUp} custom={index}>
                            <div
                                className="bg-[#374151]/20 backdrop-blur-sm rounded-xl overflow-hidden border border-[#6b7280]/30 hover:border-[#9ca3af]/50 hover:bg-[#374151]/30 transition-all duration-300 h-full flex flex-col">
                                ...
                                <div className="p-6 flex-1 flex flex-col">
                                    ...
                                    <div className="mt-4 flex flex-wrap gap-2">
                                        {cert.tags.map((t) => (
                                            <span key={t}
                                                  className="px-2 py-1 bg-[#6b7280]/30 text-[#f9fafb] text-xs rounded border border-[#9ca3af]/20">
                        {t}
                      </span>
                                        ))}
                                    </div>
            ...
            {previewCert && (
                <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-60 p-4"
                    ...
                    >
                        <div
                            className="flex items-center justify-between px-4 py-3 border-b border-[#374151] bg-[#111827]">
                            <div>
                            ...
                            {[
                                {
                                    ...
                                    icon: "fas fa-envelope",
                                    title: "Email",
                                    description: "jerminbodcheo@gmail.com"
                                },
                                {
                                    href: "https://linkedin.com/in/jerminodcheo",
                                    icon: "fab fa-linkedin",
                            ...
                            <div className="mb-6 p-4 bg-yellow-500/20 border border-yellow-500/50 rounded-lg">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <span
                                            className="text-yellow-400 font-mono text-lg bg-yellow-500/20 px-2 py-1 rounded">
